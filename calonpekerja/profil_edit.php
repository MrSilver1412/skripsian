                                    ...
                                    <div class="card">
                                        ...
                                        <div class="content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control border-input" name="status_pernikahan">
                                                            ...
                                                            <option value="Janda/Duda" <?php if($status_pernikahan == 'Janda/Duda') echo "selected"?>>Janda/Duda</option>
                                                        </select>
                                                        <?php 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control border-input" name="pendidikan_terakhir">
                                                                    <option></option>
                                                                    <option value="SD" <?php if($pendidikan_terakhir == 'SD') echo "selected"?>>SD</option>
                                                                    <option value="SMP" <?php if($pendidikan_terakhir == 'SMP') echo "selected"?>>SMP Sederajat</option>
                                                                    <option value="SMA" <?php if($pendidikan_terakhir == 'SMA') echo "selected"?>>SMA Sederajat</option>
                                                                    <option value="Diploma" <?php if($pendidikan_terakhir == 'Diploma') echo "selected"?>>Diploma</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php 
                                                                if(empty($tempat_pendidikan_terakhir)){
                                                                    echo"
                                                                    <small class='form-text' style='color: red;'>Wajib Diisi !</small>";
                                                                }
                                                                ?>
                                                ...
                                                <div class="col-md-12" style="margin-bottom: 34px;">
                                                    <div class="form-group">
                                                        <label>File CV <?php if(!empty($cv)){ echo"(Anda sudah mempunyai CV <a href='$cv'>$cv</a>)";} ?></label>
