...
?>
    ...
    <body>
        <nav class="navbar navbar-default navbar-fixed-top" color-on-scroll="200" style="color: #59ABE3;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="../index.php" class="navbar-brand" style="color: #000000;">
                    <?php echo $title ?>
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" id="dLabel" data-target="#" href="#" data-toggle="dropdown" role="button" aria-haspopup="true"
                                aria-expanded="false" style="color: #000000; border-radius: 10px;">
                                Perusahaan
                            </a>
            ...
            <div class="parallax filter filter-color-red">
                ...
                <div class="container" style="opacity: .95;">
                    <div style="margin-top: 128px;">
                        <form class="form-signin" method="POST" action="php/calonpekerja_tambah_proses.php" enctype="multipart/form-data" style="border: none;" onSubmit="return validasi_data(this)">
                            <img src="../img/signup.png" width="90px" style="margin-bottom: 20px;"/><br/>
                            <h7 class="login-text" style="color: #000000;">Daftar sebagai <b>Calon Pekerja</b>.</h7>
        ...
        <script type="text/javascript">
            function validasi_data(form) {  
                ...
                alert('Email Harap Dilengkapi !');
                form.email.focus();
                return false;
                }else if(form.username.value=="") {
                alert('Username Harap Dilengkapi !');
                form.username.focus();
                return false;
                }else if(form.password.value=="") {
                alert('Password Harap Dilengkapi !');
                form.password.focus();
                return false;
                }
            }
