            ...
            <div class="main-panel" style="float: none; width: 100%;">
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.php" style="font-weight: 800;"><?php echo $title ?></a>
                        </div>
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" id="dLabel" data-placement="bottom" title="Login User" onclick="$('#modal-user-login').modal('show');" style="margin-right: 12px; color: #FFFFFF; background-color: #D24D57; border-radius: 10px;">
                                SIGN IN
                            </a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-info" aria-labelledby="dLabel">
                                <li>
                                    <a href="perusahaan/signup.php">Calon Pekerja</a>
                                </li>
                                <li>
                                    <a href="calonpekerja/signup.php">Perusahaan</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
