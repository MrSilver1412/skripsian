                 ...
                 <div class="container" style="opacity: .95;">
                    <div style="margin-top: 128px;">
                        <form class="form-signin" method="POST" action="php/perusahaan_tambah_proses.php" enctype="multipart/form-data" style="border: none; padding: 30px 30px;">
                            <img src="../img/sign.png" width="90px" style="margin-bottom: 20px;"/><br/>
                            <h7 class="login-text" style="color: #000000;">Daftar sebagai <b>Perusahaan</b>.</h7>
                            ...
                            <input class="btn btn-primary" type="submit" value="Daftar" style="padding: 14px 20px; margin-top: 20px;" required/>
                        </form>
                    </div>
                </div>
            </div>
