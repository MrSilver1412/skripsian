            ...
            <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <span class="icon-bar bar3"></span>
                            ...
                            <a class="navbar-brand" href="#" style="font-weight: 800;"><?php echo $title ?></a>
                        </div>
                                    ...
                                    <div class="header">
                                        ...
                                        <div class="modal fade" id="search" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <form method="GET" action="daftar_lowongan.php">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title" id="myModalLabel">Pencarian Data Pelamar</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label>Nama Calon Pekerja</label>
                                                                <input type="text" class="form-control border-input" name="nama" placeholder="Judul Lowongan atau Nama Calon Pekerja" required />
                                                            </div>
                                                        </div>
                                        ...
                                        <?php
                                            if(isset($_GET['nama'])){
                                        ?>
                                            <a href="daftar_lowongan.php" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-arrow-left"></i></a>
                                            <?php
                                            }
                                        ?>
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($_GET['nama'])){
                                                        $strQuery = "SELECT * FROM lamaran as a
                                                        INNER JOIN lowongan as b ON a.lowongan_id = b.lowongan_id
                                                        INNER JOIN calon_pekerja c ON a.calon_pekerja_id = c.calon_pekerja_id
                                                        WHERE c.calon_pekerja_nama_lengkap LIKE '%$_GET[nama]%' OR b.lowongan_judul LIKE '%$_GET[nama]%' 
                                                        AND b.perusahaan_id='$_SESSION[perusahaan_id]'";
                                                        ...
                                                        INNER JOIN lowongan as b ON a.lowongan_id = b.lowongan_id
                                                        INNER JOIN calon_pekerja c ON a.calon_pekerja_id = c.calon_pekerja_id
                                                        WHERE b.perusahaan_id='$_SESSION[perusahaan_id]'
                                                        ORDER BY a.lamaran_id DESC";
                                                    }
                                                    ...
                                                    while($result = mysqli_fetch_assoc($query)){
                                                        ...
                                                        echo "<td>$result[calon_pekerja_tempat_pendidikan_terakhir]</td>";
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright pull-right">
                            ...
                            </script> <small><a><?php echo $footer ?></a></small>
                        </div>
                    </div>
                </footer>
            </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control border-input" name="nama" placeholder="Judul Lowongan" required/>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-info btn-fill">Search</button>
